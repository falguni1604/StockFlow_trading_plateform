...
import RigthSection from '../product/RigthSection';
...
function ProductPage() {
    return ( 
        ...
        appStore=""
        />
        <p className='text-center'>Want to know more about our technology stack? Check out the <Link style={{textDecoration:"none"}}>Zerodha.tech</Link> blog.</p>
        <Universe/>
        </>
     );
}
